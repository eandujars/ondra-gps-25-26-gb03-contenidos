 ...
 *
 * <p>Valida el token compartido en el header X-Service-Token para autenticar
 * peticiones service-to-service. Se ejecuta antes de JwtAuthenticationFilter,
 * permitiendo bypass de la autenticación JWT de usuario.</p>
 *
 * <p>Si el token es válido, establece autenticación con rol ROLE_SERVICE.</p>
 */
@Slf4j
@Component
...
public class ServiceTokenFilter extends OncePerRequestFilter {
    ...
    /**
     * Procesa la petición validando el token de servicio si está presente.
     *
     * <p>Si no hay token, continúa con el flujo normal. Si hay token inválido,
     * retorna error 401 sin continuar la cadena de filtros.</p>
     *
