...
public class GeneroController {
    ...
    public ResponseEntity<List<GeneroDTO>> obtenerTodosLosGeneros() {
        log.info("🎸 GET /api/generos - Lista completa");
    ...
    public ResponseEntity<GeneroDTO> obtenerGeneroPorId(@PathVariable Long id) {
        ...
        try {
            ...
            log.debug("✅ Género encontrado: {}", genero.getNombre());
            return ResponseEntity.ok(dto);

        } catch (IllegalArgumentException e) {
            log.warn("⚠️ Género no encontrado con ID: {}", id);
    ...
    public ResponseEntity<List<GeneroDTO>> buscarGeneros(
        ...
        log.info("✅ Encontrados {} géneros para: '{}'", resultados.size(), query);
