...
/**
 * Entidad intermedia para la relación muchos-a-muchos entre Album y Cancion.
 *
 * <p>Permite que una canción aparezca en múltiples álbumes con diferentes
 * números de pista. Cada combinación álbum-canción y cada número de pista
 * por álbum son únicos.</p>
 */
@Entity
...
public class AlbumCancion {
     ...
     * Comienza en 1 y debe ser único por álbum.
     */
    ...
    /**
     * Establece la fecha de agregación al crear la relación.
     */
    @PrePersist
